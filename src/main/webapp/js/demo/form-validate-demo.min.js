$.validator.setDefaults({
	highlight:function(e){
		...
		errorPlacement:function(e,r){
			e.appendTo(r.is(":radio")||r.is(":checkbox")?r.parent().parent():r.parent().parent());
		},
		errorClass:"col-sm-2 help-block m-b-none",
		validClass:"col-sm-2 help-block m-b-none"}
		),
		$().ready(function(){
			...
			$("#signupForm").validate({
				rules:{
					firstname:"required",
					lastname:"required",
					loginName:{required:true,loginName:true, rangelength: [5,11]},
					userName:{required:!0,minlength:5,maxlength:11},
				...
				messages:{
					firstname:e+"请输入你的姓",lastname:e+"请输入您的名字",
					loginName:{required:e+"请填写用户名",minlength:e+"用户名必须在5-11个字符之间"},
